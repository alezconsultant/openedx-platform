...
# .. setting_default: ['problem', 'video', 'html', 'drag-and-drop-v2', 'openassessment', 'conditional',
# 'done', 'edx_sga', 'freetextresponse', 'google-calendar', 'google-document', 'invideoquiz', 'lti',
# 'lti_consumer', 'pdf', 'poll', 'survey', 'word_cloud']
